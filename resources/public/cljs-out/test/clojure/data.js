...
return cljs.core.reduce.call(null,(function (result,p__12988){
...
var vec__12992 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__12992,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__12992,(1),null);
var ab = cljs.core.nth.call(null,vec__12992,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_12998 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_12998.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_12999 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_12999.call(null,a,b);
}
});
...
return (function (){var G__13003 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13003__$1)].join('')));
