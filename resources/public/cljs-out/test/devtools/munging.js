...
var o12754 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12754["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12755 = temp__5718__auto____$1;
return (o12755["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12589__auto__ = f;
return (o__12589__auto__["toString"]).call(o__12589__auto__);
} else {
return "";
}
}catch (e12756){var _ = e12756;
return "";
}});
...
try{var o__12589__auto___12758 = t;
(o__12589__auto___12758["cljs$lang$ctorPrWriter"]).call(o__12589__auto___12758,t,writer);
}catch (e12757){var __12759 = e12757;
}
...
var char_code = (function (){var o__12589__auto__ = (new String(char$));
return (o__12589__auto__["charCodeAt"]).call(o__12589__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12589__auto__ = String;
return (o__12589__auto__["fromCharCode"]).call(o__12589__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12760 = num_code;
switch (G__12760) {
case (1):
return (185);
...
var o__12589__auto__ = String;
return (o__12589__auto__["fromCharCode"]).call(o__12589__auto__,superscript_code);
});
/**
...
}catch (e12762){var _e__12596__auto__ = e12762;
return false;
}})())){
...
var vec__12763 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12763,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o12766 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12766["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12767 = temp__5718__auto____$1;
return (o12767["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12770){
var vec__12771 = p__12770;
var ns_detector = cljs.core.nth.call(null,vec__12771,(0),null);
...
var G__12777 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12778 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12777;
remaining_tokens = G__12778;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12768){
var G__12769 = cljs.core.first.call(null,seq12768);
var seq12768__$1 = cljs.core.next.call(null,seq12768);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12769,seq12768__$1);
}));
...
var vec__12782 = cljs.core.split_with.call(null,(function (p1__12781_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12781_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12782,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12782,(1),null);
...
var vec__12788 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12788,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12788,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12791 = cljs.core.rest.call(null,remaining_tokens);
var G__12792 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
...
var vec__12795 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12795,(0),null);
var arity = cljs.core.nth.call(null,vec__12795,(1),null);
var vec__12798 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12798,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12798,(1),null);
var vec__12801 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12801,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12801,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12801,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12801,(3),null);
...
var vec__12807 = result;
var munged_ns = cljs.core.nth.call(null,vec__12807,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12807,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12807,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12807,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12807,(4),null);
var arity = cljs.core.nth.call(null,vec__12807,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__12811 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__12811,(0),null);
var args = cljs.core.nth.call(null,vec__12811,(1),null);
var vec__12814 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12814,(0),null);
var name = cljs.core.nth.call(null,vec__12814,(1),null);
...
var G__12817 = (arity + (1));
var G__12818 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12819){
var vec__12820 = p__12819;
var arity = cljs.core.nth.call(null,vec__12820,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12820,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12823_SHARP_){
return cljs.core.get.call(null,arities,p1__12823_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12824_SHARP_){
return cljs.core.drop.call(null,(2),p1__12824_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12827){
var vec__12828 = p__12827;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12828,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12825){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12836__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12836__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12836__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12836__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12837 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12837,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12837,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12837,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12837,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12837,(4),null);
var arity = cljs.core.nth.call(null,vec__12837,(5),null);
...
var o__12589__auto__ = f;
return (o__12589__auto__["getBasis"]).call(o__12589__auto__);
});
/**
...
}catch (e12841){var _e__12596__auto__ = e12841;
...
var G__12842 = (obj[cljs.core.first.call(null,path)]);
var G__12843 = cljs.core.rest.call(null,path);
obj = G__12842;
path = G__12843;
continue;
} else {
...
var _STAR_ = (function (accum,p__12844){
var vec__12845 = p__12844;
var bit = cljs.core.nth.call(null,vec__12845,(0),null);
var protocol = cljs.core.nth.call(null,vec__12845,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12848){
var vec__12849 = p__12848;
var ns = cljs.core.nth.call(null,vec__12849,(0),null);
var name = cljs.core.nth.call(null,vec__12849,(1),null);
var selector = cljs.core.nth.call(null,vec__12849,(2),null);
...
var post_process = (function (p__12853){
var vec__12854 = p__12853;
var munged_name = cljs.core.nth.call(null,vec__12854,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12854,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12852_SHARP_){
return (obj[cljs.core.first.call(null,p1__12852_SHARP_)]);
}),sorted_matches);
