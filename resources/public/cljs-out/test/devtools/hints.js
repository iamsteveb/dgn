...
var file = cljs.core.get.call(null,map__12626__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e12625){var _e = e12625;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___12628 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___12628)){
var seen_errors_12629 = temp__5718__auto___12628;
if(cljs.core.truth_(seen_errors_12629.has(self))){
} else {
seen_errors_12629.add(self);

var temp__5720__auto___12630 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___12630)){
var sense_12631 = temp__5720__auto___12630;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12631)].join(''));
} else {
}
}
} else {
