...
args__4742__auto__.push((arguments[i__4737__auto___12889]));
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12885){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12886,G__12887,seq12885__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12891_SHARP_){
return (!((cljs.core.meta.call(null,p1__12891_SHARP_) == null)));
})))){
...
var map__12892 = opts;
var map__12892__$1 = (((((!((map__12892 == null))))?(((((map__12892.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12892.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12892):map__12892);
var markup_db = cljs.core.get.call(null,map__12892__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12896){var _e__12596__auto__ = e12896;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e12898){var _e__12596__auto__ = e12898;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12900 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12901 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12901);

try{var map__12902 = opts;
...
var markup_db = cljs.core.get.call(null,map__12902__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12900);
}});
...
var temp__5718__auto___12907 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___12907)){
var managed_print_level_12908 = temp__5718__auto___12907;
var _STAR_print_level_STAR__orig_val__12905_12909 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12906_12910 = managed_print_level_12908;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12906_12910);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__12904_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__12904_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12905_12909);
}} else {
job_fn.call(null);
}
