...
var G__12859 = devtools.prefs.pref.call(null,v);
v = G__12859;
continue;
} else {
return v;
...
}catch (e12862){var _e__12596__auto__ = e12862;
return false;
}})();
...
}catch (e12866){var _e__12596__auto__ = e12866;
return false;
}})();
...
}catch (e12868){var _e__12596__auto__ = e12868;
return false;
}}
}
});
...
var vec__12870 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12870,(0),null);
var name = cljs.core.nth.call(null,vec__12870,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12873_SHARP_);
}),template);
});
