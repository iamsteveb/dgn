...
var G__11387 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11387,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11387;
}
}));
...
var len__4736__auto___11392 = arguments.length;
var i__4737__auto___11393 = (0);
while(true){
if((i__4737__auto___11393 < len__4736__auto___11392)){
args__4742__auto__.push((arguments[i__4737__auto___11393]));

var G__11394 = (i__4737__auto___11393 + (1));
i__4737__auto___11393 = G__11394;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11389){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11390,G__11391,seq11389__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11395_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11395_SHARP_));
...
var temp__5720__auto___11398 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11398)){
var message_11399 = temp__5720__auto___11398;
cljs.core.println.call(null,message_11399);
} else {
}
...
var output_dir__$1 = (function (){var G__11402 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11402,"/"].join('');
} else {
return G__11402;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11404 = exception.stack;
var G__11404__$1 = (((G__11404 == null))?null:clojure.string.split_lines.call(null,G__11404));
var G__11404__$2 = (((G__11404__$1 == null))?null:cljs.core.get.call(null,G__11404__$1,depth));
if((G__11404__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11404__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11405 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11405,(0),null);
var column = cljs.core.nth.call(null,vec__11405,(1),null);
var vec__11408 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11408,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11408,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11408,(2),null);
...
var m__$1 = (function (){var G__11411 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11415 = (function (){var G__11414 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11414);
} else {
return G__11414;
}
})();
...
return cljs.core.vary_meta.call(null,G__11416,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11420 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11420,(0),null);
var types = vec__11420;
...
return cljs.core.map.call(null,(function (p__11423){
var vec__11424 = p__11423;
var ns = cljs.core.nth.call(null,vec__11424,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11424,(1),null);
return (function (){
...
var G__11427 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__11428 = cljs.core.seq.call(null,vars__$1);
var chunk__11429 = null;
var count__11430 = (0);
var i__11431 = (0);
while(true){
if((i__11431 < count__11430)){
var v = cljs.core._nth.call(null,chunk__11429,i__11431);
var temp__5720__auto___11433 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11433)){
var t_11434 = temp__5720__auto___11433;
each_fixture_fn.call(null,((function (seq__11428,chunk__11429,count__11430,i__11431,t_11434,temp__5720__auto___11433,v,each_fixture_fn,G__11427,G__11427__$1,env,once_fixtures,each_fixtures,vec__11424,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11434)));
});})(seq__11428,chunk__11429,count__11430,i__11431,t_11434,temp__5720__auto___11433,v,each_fixture_fn,G__11427,G__11427__$1,env,once_fixtures,each_fixtures,vec__11424,ns,vars__$1))
);
} else {
}


var G__11435 = seq__11428;
var G__11436 = chunk__11429;
var G__11437 = count__11430;
var G__11438 = (i__11431 + (1));
seq__11428 = G__11435;
chunk__11429 = G__11436;
count__11430 = G__11437;
i__11431 = G__11438;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11428);
if(temp__5720__auto__){
var seq__11428__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11428__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11428__$1);
var G__11439 = cljs.core.chunk_rest.call(null,seq__11428__$1);
var G__11440 = c__4556__auto__;
var G__11441 = cljs.core.count.call(null,c__4556__auto__);
var G__11442 = (0);
seq__11428 = G__11439;
chunk__11429 = G__11440;
count__11430 = G__11441;
i__11431 = G__11442;
continue;
} else {
var v = cljs.core.first.call(null,seq__11428__$1);
var temp__5720__auto___11443__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11443__$1)){
var t_11444 = temp__5720__auto___11443__$1;
each_fixture_fn.call(null,((function (seq__11428,chunk__11429,count__11430,i__11431,t_11444,temp__5720__auto___11443__$1,v,seq__11428__$1,temp__5720__auto__,each_fixture_fn,G__11427,G__11427__$1,env,once_fixtures,each_fixtures,vec__11424,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11444)));
});})(seq__11428,chunk__11429,count__11430,i__11431,t_11444,temp__5720__auto___11443__$1,v,seq__11428__$1,temp__5720__auto__,each_fixture_fn,G__11427,G__11427__$1,env,once_fixtures,each_fixtures,vec__11424,ns,vars__$1))
);
} else {
}


var G__11445 = cljs.core.next.call(null,seq__11428__$1);
var G__11446 = null;
var G__11447 = (0);
var G__11448 = (0);
seq__11428 = G__11445;
chunk__11429 = G__11446;
count__11430 = G__11447;
i__11431 = G__11448;
continue;
}
} else {
