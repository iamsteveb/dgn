...
var G__11389 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11389,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11389;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11391){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11392,G__11393,seq11391__$2);
}));
...
var file = cljs.core.get.call(null,map__11398__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11398__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11398__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11397_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11397_SHARP_));
...
var temp__5720__auto___11400 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11400)){
var message_11401 = temp__5720__auto___11400;
cljs.core.println.call(null,message_11401);
} else {
}
...
var temp__5720__auto___11402 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11402)){
var message_11403 = temp__5720__auto___11402;
cljs.core.println.call(null,message_11403);
} else {
}
...
var output_dir__$1 = (function (){var G__11404 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11404,"/"].join('');
} else {
return G__11404;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11406 = exception.stack;
var G__11406__$1 = (((G__11406 == null))?null:clojure.string.split_lines.call(null,G__11406));
var G__11406__$2 = (((G__11406__$1 == null))?null:cljs.core.get.call(null,G__11406__$1,depth));
if((G__11406__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11406__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11407 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11407,(0),null);
var column = cljs.core.nth.call(null,vec__11407,(1),null);
var vec__11410 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11410,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11410,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11410,(2),null);
...
var m__$1 = (function (){var G__11413 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11417 = (function (){var G__11416 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11416);
} else {
return G__11416;
}
})();
...
return cljs.core.vary_meta.call(null,G__11418,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e11419){var e = e11419;
var G__11420 = e;
var G__11420__$1 = (((G__11420 instanceof cljs.core.Keyword))?G__11420.fqn:null);
switch (G__11420__$1) {
...
var vec__11422 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11422,(0),null);
var types = vec__11422;
...
return cljs.core.map.call(null,(function (p__11425){
var vec__11426 = p__11425;
var ns = cljs.core.nth.call(null,vec__11426,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11426,(1),null);
return (function (){
...
var G__11429 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11429__$1 = (((G__11429 instanceof cljs.core.Keyword))?G__11429.fqn:null);
switch (G__11429__$1) {
case "async":
...
var seq__11430 = cljs.core.seq.call(null,vars__$1);
var chunk__11431 = null;
var count__11432 = (0);
var i__11433 = (0);
while(true){
if((i__11433 < count__11432)){
var v = cljs.core._nth.call(null,chunk__11431,i__11433);
var temp__5720__auto___11435 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11435)){
var t_11436 = temp__5720__auto___11435;
each_fixture_fn.call(null,((function (seq__11430,chunk__11431,count__11432,i__11433,t_11436,temp__5720__auto___11435,v,each_fixture_fn,G__11429,G__11429__$1,env,once_fixtures,each_fixtures,vec__11426,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11436)));
});})(seq__11430,chunk__11431,count__11432,i__11433,t_11436,temp__5720__auto___11435,v,each_fixture_fn,G__11429,G__11429__$1,env,once_fixtures,each_fixtures,vec__11426,ns,vars__$1))
);
} else {
}


var G__11437 = seq__11430;
var G__11438 = chunk__11431;
var G__11439 = count__11432;
var G__11440 = (i__11433 + (1));
seq__11430 = G__11437;
chunk__11431 = G__11438;
count__11432 = G__11439;
i__11433 = G__11440;
continue;
} else {
...
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11430__$1);
var G__11441 = cljs.core.chunk_rest.call(null,seq__11430__$1);
var G__11442 = c__4556__auto__;
var G__11443 = cljs.core.count.call(null,c__4556__auto__);
var G__11444 = (0);
seq__11430 = G__11441;
...
var v = cljs.core.first.call(null,seq__11430__$1);
var temp__5720__auto___11445__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11445__$1)){
var t_11446 = temp__5720__auto___11445__$1;
each_fixture_fn.call(null,((function (seq__11430,chunk__11431,count__11432,i__11433,t_11446,temp__5720__auto___11445__$1,v,seq__11430__$1,temp__5720__auto__,each_fixture_fn,G__11429,G__11429__$1,env,once_fixtures,each_fixtures,vec__11426,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11446)));
});})(seq__11430,chunk__11431,count__11432,i__11433,t_11446,temp__5720__auto___11445__$1,v,seq__11430__$1,temp__5720__auto__,each_fixture_fn,G__11429,G__11429__$1,env,once_fixtures,each_fixtures,vec__11426,ns,vars__$1))
);
} else {
}


var G__11447 = cljs.core.next.call(null,seq__11430__$1);
var G__11448 = null;
var G__11449 = (0);
var G__11450 = (0);
seq__11430 = G__11447;
chunk__11431 = G__11448;
count__11432 = G__11449;
i__11433 = G__11450;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11429__$1)].join('')));
