...
var o12828 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12828["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12829 = temp__5718__auto____$1;
return (o12829["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12663__auto__ = f;
return (o__12663__auto__["toString"]).call(o__12663__auto__);
} else {
return "";
}
}catch (e12830){var _ = e12830;
return "";
}});
...
try{var o__12663__auto___12832 = t;
(o__12663__auto___12832["cljs$lang$ctorPrWriter"]).call(o__12663__auto___12832,t,writer);
}catch (e12831){var __12833 = e12831;
}
...
var char_code = (function (){var o__12663__auto__ = (new String(char$));
return (o__12663__auto__["charCodeAt"]).call(o__12663__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12663__auto__ = String;
return (o__12663__auto__["fromCharCode"]).call(o__12663__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12834 = num_code;
switch (G__12834) {
case (1):
return (185);
...
var o__12663__auto__ = String;
return (o__12663__auto__["fromCharCode"]).call(o__12663__auto__,superscript_code);
});
/**
...
}catch (e12836){var _e__12670__auto__ = e12836;
return false;
}})())){
...
var vec__12837 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12837,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o12840 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12840["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12841 = temp__5718__auto____$1;
return (o12841["nameToPath"]);
} else {
return null;
}
} else {
...
var ns_detector = cljs.core.nth.call(null,vec__12845,(0),null);
...
var G__12851 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12852 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12851;
...
var G__12843 = cljs.core.first.call(null,seq12842);
var seq12842__$1 = cljs.core.next.call(null,seq12842);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12843,seq12842__$1);
}));
...
var vec__12856 = cljs.core.split_with.call(null,(function (p1__12855_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12855_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12856,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12856,(1),null);
...
var vec__12862 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12862,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12862,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12865 = cljs.core.rest.call(null,remaining_tokens);
var G__12866 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12865;
name_tokens = G__12866;
continue;
} else {
...
var vec__12869 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12869,(0),null);
var arity = cljs.core.nth.call(null,vec__12869,(1),null);
var vec__12872 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12872,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12872,(1),null);
var vec__12875 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12875,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12875,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12875,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12875,(3),null);
...
var vec__12881 = result;
var munged_ns = cljs.core.nth.call(null,vec__12881,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12881,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12881,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12881,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12881,(4),null);
var arity = cljs.core.nth.call(null,vec__12881,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__12885 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__12885,(0),null);
var args = cljs.core.nth.call(null,vec__12885,(1),null);
var vec__12888 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12888,(0),null);
var name = cljs.core.nth.call(null,vec__12888,(1),null);
...
var G__12891 = (arity + (1));
var G__12892 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12893){
var vec__12894 = p__12893;
var arity = cljs.core.nth.call(null,vec__12894,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12894,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12897_SHARP_){
return cljs.core.get.call(null,arities,p1__12897_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12898_SHARP_){
return cljs.core.drop.call(null,(2),p1__12898_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___12905 = arguments.length;
var i__4737__auto___12906 = (0);
while(true){
if((i__4737__auto___12906 < len__4736__auto___12905)){
args__4742__auto__.push((arguments[i__4737__auto___12906]));

var G__12907 = (i__4737__auto___12906 + (1));
i__4737__auto___12906 = G__12907;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12901){
var vec__12902 = p__12901;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12902,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12899){
var G__12900 = cljs.core.first.call(null,seq12899);
var seq12899__$1 = cljs.core.next.call(null,seq12899);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12900,seq12899__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12910__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12910__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12910__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12910__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12911 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12911,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12911,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12911,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12911,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12911,(4),null);
var arity = cljs.core.nth.call(null,vec__12911,(5),null);
...
var o__12663__auto__ = f;
return (o__12663__auto__["getBasis"]).call(o__12663__auto__);
});
/**
...
}catch (e12915){var _e__12670__auto__ = e12915;
...
var G__12916 = (obj[cljs.core.first.call(null,path)]);
var G__12917 = cljs.core.rest.call(null,path);
obj = G__12916;
path = G__12917;
continue;
} else {
...
var _STAR_ = (function (accum,p__12918){
var vec__12919 = p__12918;
var bit = cljs.core.nth.call(null,vec__12919,(0),null);
var protocol = cljs.core.nth.call(null,vec__12919,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12922){
var vec__12923 = p__12922;
var ns = cljs.core.nth.call(null,vec__12923,(0),null);
var name = cljs.core.nth.call(null,vec__12923,(1),null);
var selector = cljs.core.nth.call(null,vec__12923,(2),null);
...
var post_process = (function (p__12927){
var vec__12928 = p__12927;
var munged_name = cljs.core.nth.call(null,vec__12928,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12928,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12926_SHARP_){
return (obj[cljs.core.first.call(null,p1__12926_SHARP_)]);
}),sorted_matches);
