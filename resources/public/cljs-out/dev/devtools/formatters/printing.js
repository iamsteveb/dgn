...
var len__4736__auto___12962 = arguments.length;
var i__4737__auto___12963 = (0);
while(true){
if((i__4737__auto___12963 < len__4736__auto___12962)){
args__4742__auto__.push((arguments[i__4737__auto___12963]));

var G__12964 = (i__4737__auto___12963 + (1));
i__4737__auto___12963 = G__12964;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12959){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12960,G__12961,seq12959__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12965_SHARP_){
return (!((cljs.core.meta.call(null,p1__12965_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__12966__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12970){var _e__12670__auto__ = e12970;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e12972){var _e__12670__auto__ = e12972;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12974 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12975 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12975);

try{var map__12976 = opts;
...
var markup_db = cljs.core.get.call(null,map__12976__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12974);
}});
...
var temp__5718__auto___12981 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___12981)){
var managed_print_level_12982 = temp__5718__auto___12981;
var _STAR_print_level_STAR__orig_val__12979_12983 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12980_12984 = managed_print_level_12982;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12980_12984);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__12978_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__12978_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12979_12983);
}} else {
job_fn.call(null);
}
