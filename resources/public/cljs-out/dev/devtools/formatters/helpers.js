...
var G__12933 = devtools.prefs.pref.call(null,v);
v = G__12933;
continue;
} else {
return v;
...
}catch (e12936){var _e__12670__auto__ = e12936;
return false;
}})();
...
}catch (e12940){var _e__12670__auto__ = e12940;
return false;
}})();
...
}catch (e12942){var _e__12670__auto__ = e12942;
return false;
}}
}
});
...
var vec__12944 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12944,(0),null);
var name = cljs.core.nth.call(null,vec__12944,(1),null);
...
return cljs.core.some.call(null,(function (p1__12947_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12947_SHARP_);
}),template);
});
