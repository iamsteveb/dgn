...
return cljs.core.map.call(null,(function (p1__11668_SHARP_){
return html_coll.item(p1__11668_SHARP_);
...
return cljs.core.some.call(null,(function (p1__11669_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__11669_SHARP_);
...
var ctx_11670 = cvs.getContext("2d");
(ctx_11670.fillStyle = color);

ctx_11670.fillRect((0),(0),size,size);
