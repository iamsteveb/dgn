window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=e203fc&fwbuild=test"};
...
document.write('<script>goog.require("dgn.test_runner");</script>');
