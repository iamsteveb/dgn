window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=c18d7a&fwbuild=dev"};
...
document.write('<script>goog.require("dgn.core");</script>');
